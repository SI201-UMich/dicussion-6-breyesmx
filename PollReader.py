...
class PollReader():
    ...
    def polling_history_change(self):
        ...
        latter_harris = sum(self.data_dict ["Harris result"][ :30]) / 30
        latter_trump = sum(self.data_dict ["Trump result"][:30]) / 30

        return ((latter_harris - early_harris), (latter_trump - early_trump))
